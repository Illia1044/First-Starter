...
6. зробіть та збережіть у файл task1.1.png **скріншот** результатів роботи програми 
...
11. додайте до репозиторію обидва скріншоти
...
1. додайте в проект файл **Quotation.java** з таким вмістом:
...
4. **запустіть** його (<kbd>F6</kbd> у NetBeans)
5. зробіть та збережіть у файл task2.1.png **скріншот** результатів роботи програми 
...
8. зробіть та збережіть у файл task2.2.png **скріншот** нових результатів роботи програми 
9. додайте до репозиторію обидва скріншоти
10. створіть файл **task2.md** і додайте туди ці скріншоти (УВАГА! Має бути видно код програми!)
...
- :three: на "три" - просто виконані завдання 1 та 2
- :four: на "чотири" - те, що на "три", плюс, добре оформлені файли task1.md та task2.md
- :five: на "п'ять" - змінити код завдань таким чином, щоб:
