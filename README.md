...
1. клонуйте створений для вас репозиторій в Netbeans (детальна інструкція з картинками є [тут](https://netbeans.org/kb/docs/ide/git.html)), відкрийте в [Repl.It](https://repl.it/) ([ось](https://repl.it/talk/learn/Configuring-GitHub-repos-to-run-on-Replit-and-contributing-back/23948) покрокова інструкція з картинками) або просто завантажте його вміст у ZIP-форматі (скориставшись кнопкою &#2913; Code" > "Download ZIP") і відкрийте в IDE за вашим вибором
